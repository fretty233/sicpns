		...
		<div class="box box-primary color-palette-box" style="overflow-y: scroll;">
			<div class="box-header with-border">
				...
				<div class="pull-right">
					<td width="33%" align="right"><a href="{!! $data->soal !!}" role="button" class="btn btn-primary"><b><i class="fa fa-angle-double-left"></i> Back</b></a></td>
					<td width="33%" align="left"><a href="{!! $data->soal !!}" role="button" class="btn btn-primary"><b>Next <i class="fa fa-angle-double-right"></i></b></a></td>
				</div>
			</div>
			<div class="box-body">
				<div id="wrap-soal">
