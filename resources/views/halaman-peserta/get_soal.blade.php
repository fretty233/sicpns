<?php
	if ($soal->checkJawab) {
		$jawab_peserta = $soal->checkJawab->pilihan;
	}else{
		$jawab_peserta = '';
	}
?>
...
<?php if ($soal->pila) {?>
	<div class="jawab {{ $jawab_peserta == 'A' ? 'dijawab' : '' }}"
...
<?php } ?>
<?php if ($soal->pilb) {?>
	<div class="jawab {{ $jawab_peserta == 'B' ? 'dijawab' : '' }}"
		soal-id="{{ $soal->id_soal }}"
		data-id="{{ $soal->id }}"
...
<?php } ?>
<?php if ($soal->pilc) {?>
	<div class="jawab {{ $jawab_peserta == 'C' ? 'dijawab' : '' }}"
		soal-id="{{ $soal->id_soal }}"
		data-id="{{ $soal->id }}"
...
<?php } ?>
<?php if ($soal->pild) {?>
	<div class="jawab {{ $jawab_peserta == 'D' ? 'dijawab' : '' }}"
		soal-id="{{ $soal->id_soal }}"
		data-id="{{ $soal->id }}"
...
<?php } ?>
<?php if ($soal->pile) {?>
	<div class="jawab {{ $jawab_peserta == 'E' ? 'dijawab' : '' }}"
		soal-id="{{ $soal->id_soal }}"
		data-id="{{ $soal->id }}"
