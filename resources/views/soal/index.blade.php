  ...
  <div class="box box-primary">
    ...
    <div class="box-body">
      ...
      <div class="well" style="margin-top: 15px; display: none;" id="wrap-soal">
        <form class="form-horizontal" id="formSoal">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="paket" class="col-sm-2 control-label">Nama Paket</label>
              <div class="col-sm-8">
                <input type="text" class="form-control" name="paket" placeholder="Isi Nama Paket">
              </div>
            </div>
            <div class="form-group">
      ...
      <table class="table table-hover table-striped" id="table_soal">
      	@if (Auth::user()->status == 'Mentor' || Auth::user()->status == 'Admin' )
