              ...
              <div id="wrap-status-soal{{ $data_kelas->id }}">
                @if($data_kelas->id_soal != "")
                  @if($data_kelas->id_soal == Request::segment(4))
                    <span id="terbit-soal{{ $data_kelas->id }}">
                      <button id="terbit-soal{{ $data_kelas->id }}" style="color: white; font-size: 8pt;  cursor: pointer; text-align: justify;" class="btn btn-primary btn-sm">Terbitkan</button>
                    </span>
                  @else
                    <span id="terbit-soal{{ $data_kelas->id }}">
                      <button style="color: white; font-size: 9pt; font-weight: bold; cursor: pointer; text-align: justify;" class="btn btn-primary btn-sm">Terbitkan</button>
                    </span>
                  @endif
                @endif
              </div>
              ...
              $("#terbit-soal{{ $data_kelas->id }}").click(function() {
                ...
                $.ajax({
                  ...
                  success: function(data) {
                    if (data == 'Y') {
                      $("#terbit-soal{{ $data_kelas->id }}").html('<i data-toggle="tooltip" data-html="true" data-delay="{"show":100, "hide":10}" title="Kelas ini dapat mengerjakan soal <b>{{ $soal->paket }}</b>.<br>Klik untuk mengubah aksi." style="color: limegreen; font-size: 15pt; cursor: pointer;" class="fa fa-check-square"></i>');
                    } else {
                      $("#terbit-soal{{ $data_kelas->id }}").html('<i data-toggle="tooltip" data-html="true" data-delay="{"show":100, "hide":10}" title="Kelas ini tidak dapat mengerjakan soal <b>{{ $soal->paket }}</b>.<br>Klik untuk mengubah aksi." style="color: red; font-size: 15pt; cursor: pointer;" class="fa fa-minus-square"></i>');
                    }
                  }
                });
              });
          ...
          <div class="box-body">
            ...
            <div class="form-group" style="margin-top: 20px">
              <div class="col-sm-offset-2 col-sm-10">
                ...
                <div id="wrap-btn">
                  <button type="button" class="btn btn-success" id="simpan-soal" onClick="window.location.reload();">Simpan</button>
