...
<div class="col-md-4">
  <div class="box box-warning">
    ...
    <div class="box-body">
      <p>Tulis materi sesuai yang Anda kuasai untuk dapat diakses oleh peserta Anda. Semakin banyak materi yang di publish akan memperkaya konten dari aplikasi ini dan bermanfaat untuk peserta Anda.</p>
    </div>
  </div>
</div>
@endsection
...
$(document).ready(function (){
  table_materi = $('#table_materi').DataTable({
    ...
    lengthChange: true,
    ajax: {
      url: '{!! route('tryout.dataMateriMentor') !!}',
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        if (data == 'ok') {
          ...
          window.location = "{{ url('/tryout/materi') }}";
        }else{
          $("#loading").hide();
          $("#wrap-btn").show();
